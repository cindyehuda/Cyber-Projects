...
After filtering relevant RDP (port 3389) traffic in Splunk, three IP addresses appeared suspicious: image image
...
rdp_bruteforce_threshold
Triggered 3 times
Indicates high-frequency login attempts
image
rdp_bruteforce_blocked_ip
Triggered 2 times
